...
\begin{tabularx}{\linewidth}{C{0.19411764705882353\linewidth}@{}VC{0.2470588235294118\linewidth}@{}VC{0.4588235294117647\linewidth}@{}Y>{\color{black}\bfseries}b{0.1\linewidth}@{}}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{greyi} & \cellcolor{green} & {\multirow{1}{*}{BM33\_M}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{blue} & \cellcolor{greyi} & {\multirow{1}{*}{BM33\_P}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
...
[ ,name=1,l*=3.235294117647059, edge={red,line width=0.3cm}
[ ,name=2,l*=4.11764705882353, edge={blue,line width=0.3cm},label={right: \bf{\makecell[l]{BM33\_P}}}]
[ ,name=3,l*=7.647058823529411, edge={green,line width=0.3cm},label={right: \bf{\makecell[l]{BM33\_M}}}]
]
]
\end{forest}
} \\
