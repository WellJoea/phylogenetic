...
\begin{tabularx}{\linewidth}{C{0.3399540757749713\linewidth}@{}VC{0.11262916188289324\linewidth}@{}VC{0.4474167623421355\linewidth}@{}Y>{\color{black}\bfseries}b{0.1\linewidth}@{}}
\addstackgap[20pt]{\cellcolor{greyi}} & \cellcolor{greyi} & \cellcolor{green} & {\multirow{1}{*}{BM38\_M}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{blue} & \cellcolor{greyi} & {\multirow{1}{*}{BM38\_P}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
...
[ ,name=1,l*=5.665901262916188, edge={red,line width=0.3cm}
[ ,name=2,l*=1.8771526980482207, edge={blue,line width=0.3cm},label={right: \bf{\makecell[l]{BM38\_P}}}]
]
[ ,name=3,l*=7.456946039035591, edge={green,line width=0.3cm},label={right: \bf{\makecell[l]{BM38\_M}}}]
]
\end{forest}
} \\
