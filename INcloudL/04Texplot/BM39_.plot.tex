...
\begin{tabularx}{\linewidth}{C{0.5875\linewidth}@{}VC{0.3125\linewidth}@{}Y>{\color{black}\bfseries}b{0.1\linewidth}@{}}
\addstackgap[20pt]{\cellcolor{greyi}} & \cellcolor{blue} & {\multirow{1}{*}{BM39\_M}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{greyi} & {\multirow{1}{*}{BM39\_P}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
...
[ ,name=1,l*=9.791666666666666, edge={red,line width=0.3cm},label={right: \bf{\makecell[l]{BM39\_P}}}]
[ ,name=2,l*=5.208333333333333, edge={blue,line width=0.3cm},label={right: \bf{\makecell[l]{BM39\_M}}}]
]
\end{forest}
} \\
