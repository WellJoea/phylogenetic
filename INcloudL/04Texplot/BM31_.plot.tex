...
\begin{tabularx}{\linewidth}{C{0.17857142857142858\linewidth}@{}VC{0.25\linewidth}@{}VC{0.4714285714285715\linewidth}@{}Y>{\color{black}\bfseries}b{0.1\linewidth}@{}}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{greyi} & \cellcolor{green} & {\multirow{1}{*}{BM31\_M}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{blue} & \cellcolor{greyi} & {\multirow{1}{*}{BM31\_P}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
...
[ ,name=1,l*=2.9761904761904754, edge={red,line width=0.3cm}
[ ,name=2,l*=4.166666666666666, edge={blue,line width=0.3cm},label={right: \bf{\makecell[l]{BM31\_P}}}]
[ ,name=3,l*=7.857142857142858, edge={green,line width=0.3cm},label={right: \bf{\makecell[l]{BM31\_M}}}]
]
]
\end{forest}
} \\
