...
\begin{tabularx}{\linewidth}{C{0.21951219512195122\linewidth}@{}VC{0.15365853658536588\linewidth}@{}VC{0.526829268292683\linewidth}@{}Y>{\color{black}\bfseries}b{0.1\linewidth}@{}}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{greyi} & \cellcolor{green} & {\multirow{1}{*}{BM34\_M}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{blue} & \cellcolor{greyi} & {\multirow{1}{*}{BM34\_P}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
...
[ ,name=1,l*=3.6585365853658534, edge={red,line width=0.3cm}
[ ,name=2,l*=2.5609756097560976, edge={blue,line width=0.3cm},label={right: \bf{\makecell[l]{BM34\_P}}}]
[ ,name=3,l*=8.780487804878048, edge={green,line width=0.3cm},label={right: \bf{\makecell[l]{BM34\_M}}}]
]
]
\end{forest}
} \\
