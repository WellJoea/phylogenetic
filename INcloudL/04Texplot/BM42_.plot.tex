...
\begin{tabularx}{\linewidth}{C{0.10112359550561797\linewidth}@{}VC{0.09101123595505618\linewidth}@{}VC{0.7078651685393259\linewidth}@{}Y>{\color{black}\bfseries}b{0.1\linewidth}@{}}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{greyi} & \cellcolor{green} & {\multirow{1}{*}{BM42\_M}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{blue} & \cellcolor{greyi} & {\multirow{1}{*}{BM42\_P}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
...
[ ,name=1,l*=1.685393258426966, edge={red,line width=0.3cm}
[ ,name=2,l*=1.5168539325842694, edge={blue,line width=0.3cm},label={right: \bf{\makecell[l]{BM42\_P}}}]
[ ,name=3,l*=11.797752808988763, edge={green,line width=0.3cm},label={right: \bf{\makecell[l]{BM42\_M}}}]
]
]
\end{forest}
} \\
