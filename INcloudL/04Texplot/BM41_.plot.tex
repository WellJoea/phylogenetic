...
\begin{tabularx}{\linewidth}{C{0.03313106796116505\linewidth}@{}VC{0.19514563106796118\linewidth}@{}VC{0.6717233009708737\linewidth}@{}Y>{\color{black}\bfseries}b{0.1\linewidth}@{}}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{blue} & \cellcolor{green} & {\multirow{1}{*}{BM41\_M}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{greyi} & \cellcolor{greyi} & {\multirow{1}{*}{BM41\_P}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
...
[ ,name=1,l*=0.5521844660194176, edge={red,line width=0.3cm}
[ ,name=2,l*=3.2524271844660197, edge={blue,line width=0.3cm}
[ ,name=3,l*=11.195388349514564, edge={green,line width=0.3cm},label={right: \bf{\makecell[l]{BM41\_M}}}]
]
]
]
\end{forest}
