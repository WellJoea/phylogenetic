...
\begin{tabularx}{\linewidth}{C{0.084375\linewidth}@{}VC{0.140625\linewidth}@{}VC{0.28125\linewidth}@{}VC{0.18000000000000002\linewidth}@{}VC{0.21375\linewidth}@{}Y>{\color{black}\bfseries}b{0.1\linewidth}@{}}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{blue} & \cellcolor{green} & \cellcolor{greyi} & \cellcolor{greyi} & {\multirow{1}{*}{BM36\_L}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{blue} & \cellcolor{greyi} & \cellcolor{greyi} & \cellcolor{magenta} & {\multirow{1}{*}{BM36\_M}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{greyi} & \cellcolor{greyi} & \cellcolor{yellow} & \cellcolor{greyi} & {\multirow{1}{*}{BM36\_P}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
...
[ ,name=4,l*=1.40625, edge={red,line width=0.3cm}
[ ,name=1,l*=2.34375, edge={blue,line width=0.3cm}
[ ,name=2,l*=4.6875, edge={green,line width=0.3cm},label={right: \bf{\makecell[l]{BM36\_L}}}]
[ ,name=5,l*=3.5625, edge={magenta,line width=0.3cm},label={right: \bf{\makecell[l]{BM36\_M}}}]
]
[ ,name=3,l*=3.0, edge={yellow,line width=0.3cm},label={right: \bf{\makecell[l]{BM36\_P}}}]
]
]
\end{forest}
} \\
