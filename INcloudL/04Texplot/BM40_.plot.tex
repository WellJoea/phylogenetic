...
\begin{tabularx}{\linewidth}{C{0.14545454545454548\linewidth}@{}VC{0.34545454545454546\linewidth}@{}VC{0.40909090909090906\linewidth}@{}Y>{\color{black}\bfseries}b{0.1\linewidth}@{}}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{greyi} & \cellcolor{green} & {\multirow{1}{*}{BM40\_M}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
\addstackgap[20pt]{\cellcolor{red}} & \cellcolor{blue} & \cellcolor{greyi} & {\multirow{1}{*}{BM40\_P}} \\ 
\specialrule{0em}{2.6pt}{2.6pt}
...
[ ,name=1,l*=2.4242424242424243, edge={red,line width=0.3cm}
[ ,name=2,l*=5.757575757575757, edge={blue,line width=0.3cm},label={right: \bf{\makecell[l]{BM40\_P}}}]
[ ,name=3,l*=6.8181818181818175, edge={green,line width=0.3cm},label={right: \bf{\makecell[l]{BM40\_M}}}]
]
]
\end{forest}
} \\
