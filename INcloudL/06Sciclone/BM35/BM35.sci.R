...
library(clonevol)
library(fishplot)
OUT='/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/06Sciclone/BM35'
GROUP='BM35'
OUThead=paste(OUT, GROUP, sep = "/")
## read in the data - copy number
cn1 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/03CNV/BM35_M.cnv.txt",sep="\t",stringsAsFactors=F)[,c(1,2,3,5)]
cn2 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/03CNV/BM35_P.cnv.txt",sep="\t",stringsAsFactors=F)[,c(1,2,3,5)]
head(cn1)
## read in vaf data
v1 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/02SNV/BM35_M.vafs",sep="\t",stringsAsFactors=F,header=T)
v2 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/02SNV/BM35_P.vafs",sep="\t",stringsAsFactors=F,header=T)
samples = c('BM35_M', 'BM35_P')
...
vafs = data.frame(cluster=sc@vafs.merged$cluster,
                  BM35_M = sc@vafs.merged$BM35_M.vaf,
                  BM35_P = sc@vafs.merged$BM35_P.vaf,
                  stringsAsFactors=F
                  )
