...
library(clonevol)
library(fishplot)
OUT='/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/06Sciclone/BM32'
GROUP='BM32'
OUThead=paste(OUT, GROUP, sep = "/")
## read in the data - copy number
cn1 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/03CNV/BM32_L.cnv.txt",sep="\t",stringsAsFactors=F)[,c(1,2,3,5)]
cn2 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/03CNV/BM32_M.cnv.txt",sep="\t",stringsAsFactors=F)[,c(1,2,3,5)]
cn3 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/03CNV/BM32_P.cnv.txt",sep="\t",stringsAsFactors=F)[,c(1,2,3,5)]
head(cn1)
## read in vaf data
v1 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/02SNV/BM32_L.vafs",sep="\t",stringsAsFactors=F,header=T)
v2 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/02SNV/BM32_M.vafs",sep="\t",stringsAsFactors=F,header=T)
v3 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/02SNV/BM32_P.vafs",sep="\t",stringsAsFactors=F,header=T)
samples = c('BM32_L', 'BM32_M', 'BM32_P')
...
vafs = data.frame(cluster=sc@vafs.merged$cluster,
                  BM32_L = sc@vafs.merged$BM32_L.vaf,
                  BM32_M = sc@vafs.merged$BM32_M.vaf,
                  BM32_P = sc@vafs.merged$BM32_P.vaf,
                  stringsAsFactors=F
                  )
