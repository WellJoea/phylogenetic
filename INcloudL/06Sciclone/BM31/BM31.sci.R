...
library(clonevol)
library(fishplot)
OUT='/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/06Sciclone/BM31'
GROUP='BM31'
OUThead=paste(OUT, GROUP, sep = "/")
## read in the data - copy number
cn1 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/03CNV/BM31_M.cnv.txt",sep="\t",stringsAsFactors=F)[,c(1,2,3,5)]
cn2 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/03CNV/BM31_P.cnv.txt",sep="\t",stringsAsFactors=F)[,c(1,2,3,5)]
head(cn1)
## read in vaf data
v1 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/02SNV/BM31_M.vafs",sep="\t",stringsAsFactors=F,header=T)
v2 = read.table("/lustre/rde/user/guoxc/project/181126_12Sample_BrM/phylogenetic/INcloudL/02SNVCNV/02SNV/BM31_P.vafs",sep="\t",stringsAsFactors=F,header=T)
samples = c('BM31_M', 'BM31_P')
...
vafs = data.frame(cluster=sc@vafs.merged$cluster,
                  BM31_M = sc@vafs.merged$BM31_M.vaf,
                  BM31_P = sc@vafs.merged$BM31_P.vaf,
                  stringsAsFactors=F
                  )
